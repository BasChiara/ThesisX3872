...
// Thu Mar 31 16:41:08 2022 by ROOT version 6.24/06
// from TTree Events/Events
// found on file: /eos/cms/store/group/phys_egamma/crovelli/LowPtEle/B0ToXKs_2022Mar30/BdToX3872Ks_X3872ToJpsiRho_BMuonFilter_DGamma0_TuneCUEP8M1_13TeV-pythia8-evtgen/crab_BdToX3872Ks/220330_155143/0000/xNANO_mc_2022Mar30_49.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   ULong64_t       event;
   UInt_t          nB0;
   Float_t         B0_cosAlpha_PV[24];   //[nB0]
   Float_t         B0_dxySignMu1[24];   //[nB0]
   Float_t         B0_dxySignMu2[24];   //[nB0]
   Float_t         B0_dxySignTr1[24];   //[nB0]
   Float_t         B0_dxySignTr2[24];   //[nB0]
   Float_t         B0_dzSignMu1[24];   //[nB0]
   Float_t         B0_dzSignMu2[24];   //[nB0]
   Float_t         B0_dzSignTr1[24];   //[nB0]
   Float_t         B0_dzSignTr2[24];   //[nB0]
   Float_t         B0_fit_eta[24];   //[nB0]
   Float_t         B0_fit_mass[24];   //[nB0]
   Float_t         B0_fit_phi[24];   //[nB0]
   Float_t         B0_fit_pt[24];   //[nB0]
   Float_t         B0_fitted_JPsi_mass[24];   //[nB0]
   Float_t         B0_fitted_Rho_mass[24];   //[nB0]
   Float_t         B0_fitted_X_mass[24];   //[nB0]
   Float_t         B0_fitted_mass_womc[24];   //[nB0]
   Float_t         B0_lxySign_PV[24];   //[nB0]
   Float_t         B0_svchi2[24];   //[nB0]
   Float_t         B0_svprob[24];   //[nB0]
   Int_t           B0_dilepton_idx[24];   //[nB0]
   Int_t           B0_dipion_idx[24];   //[nB0]
   Int_t           B0_k0short_idx[24];   //[nB0]
   Int_t           B0_mu1_idx[24];   //[nB0]
   Int_t           B0_mu2_idx[24];   //[nB0]
   Int_t           B0_pv_idx[24];   //[nB0]
   Int_t           B0_trk1Rho_idx[24];   //[nB0]
   Int_t           B0_trk2Rho_idx[24];   //[nB0]
   UInt_t          nJPsiToMuMu;
   ...
   virtual void     gen_Daugh_ptetaphiM( const Int_t& Mother_pdgId,ROOT::Math::PtEtaPhiMVector* V_neg,ROOT::Math::PtEtaPhiMVector* V_pos );
	virtual void     gen_K0s_ptetaphiM(ROOT::Math::PtEtaPhiMVector* V_gen);
   virtual void     FillPtEtaPhiM(const int& Ptl_Idx, ROOT::Math::PtEtaPhiMVector* rec4V, const int PDGid);
   virtual int      find_minDeltaR(const ROOT::Math::PtEtaPhiMVector& gen4V, const int analysis_code);
   virtual double   score_PT(const int track_idx, const ROOT::Math::PtEtaPhiMVector& gen4V, const int analysis_code);
   virtual bool     isReconstructedTrack(const int& DR_min_idx , const ROOT::Math::PtEtaPhiMVector& gen4V, const int& analysis_code);
...
#ifdef MassAnalysis_cxx
MassAnalysis::MassAnalysis(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/eos/cms/store/group/phys_egamma/crovelli/LowPtEle/B0ToXKs_2022Mar30/BdToX3872Ks_X3872ToJpsiRho_BMuonFilter_DGamma0_TuneCUEP8M1_13TeV-pythia8-evtgen/crab_BdToX3872Ks/220330_155143/0000/xNANO_mc_2022Mar30_49.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/eos/cms/store/group/phys_egamma/crovelli/LowPtEle/B0ToXKs_2022Mar30/BdToX3872Ks_X3872ToJpsiRho_BMuonFilter_DGamma0_TuneCUEP8M1_13TeV-pythia8-evtgen/crab_BdToX3872Ks/220330_155143/0000/xNANO_mc_2022Mar30_49.root");
      }
...
Int_t MassAnalysis::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MassAnalysis::LoadTree(Long64_t entry)
{
...
void MassAnalysis::Init(TTree *tree)
{
...
void MassAnalysis::Show(Long64_t entry)
{
...
Int_t MassAnalysis::Cut(Long64_t entry)
{
