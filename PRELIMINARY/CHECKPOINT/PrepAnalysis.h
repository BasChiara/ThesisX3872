...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   UInt_t          nGenPart;
   Float_t         GenPart_eta[70];   //[nGenPart]
   Float_t         GenPart_mass[70];   //[nGenPart]
   Float_t         GenPart_phi[70];   //[nGenPart]
   Float_t         GenPart_pt[70];   //[nGenPart]
   Float_t         GenPart_vx[70];   //[nGenPart]
   Float_t         GenPart_vy[70];   //[nGenPart]
   Float_t         GenPart_vz[70];   //[nGenPart]
   Int_t           GenPart_genPartIdxMother[70];   //[nGenPart]
   Int_t           GenPart_pdgId[70];   //[nGenPart]
   Int_t           GenPart_status[70];   //[nGenPart]
   Int_t           GenPart_statusFlags[70];   //[nGenPart]
   ...
   virtual void     gen_Mu_etaphi(double* eta_realMum, double* phi_realMum,double* eta_realMup, double* phi_realMup);
