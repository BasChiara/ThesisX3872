...
parser.add_option("-i", "--input", dest="input",
                  help="batch directory to be checked", default = "/eos/user/c/cbasile/HLTapplyPsi2S")

parser.add_option("-o", "--output", dest="output",
                  help="directory to save the merged files", default = "/afs/cern.ch/user/c/cbasile/CMSSW-10-6-20-Analysis/src/BParkNANO/B0toPsi2SK0s/data")
...
outTreeName = "B0_Psi2Ssignal"
mergeOutFileName = "SGNPsi2S_MergData17.root"
mergeOutHistName = "Psi2Shisto_MergData17.root"
...
TotEvents = 0
SampleEvs = 0
chain = ROOT.TChain("B0_Psi2Ssignal")
