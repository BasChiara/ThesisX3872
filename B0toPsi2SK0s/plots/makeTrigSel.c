{
	...
	//--> KVTXfit_SGN_K0s_M0s 
	draw2StackedHistos("VTXfit_BKG_K0s_M" , "VTX_BKG_K0s", "VTXfit_SGN_K0s_M", "VTX_SGN_K0s", "M(K_{0}^{s})[GeV]");

	//--> X(3872)
	draw_Ncandidates("Ncandidate_Psi2S", "Psi2S", "");
	draw2StackedHistos("PREfit_BKG_Psi2S_M" , "PRE_BKG_Psi2S", "PREfit_SGN_Psi2S_M", "PRE_SGN_Psi2S", "M(#mu^{+} #mu^{-}#pi^{+} #pi^{-})[GeV]");
	draw2StackedHistos("TOTfit_BKG_Psi2S_M" , "TOT_BKG_Psi2S", "TOTfit_SGN_Psi2S_M", "TOT_SGN_Psi2S", "M(#mu^{+} #mu^{-}#pi^{+} #pi^{-})[GeV]");

	//--> B0
	draw_Ncandidates("Ncandidate_B0", "B0", "");
	draw2StackedHistos("TOTfit_BKG_B0_M" , "TOT_BKG_B0", "TOTfit_SGN_B0_M", "TOT_SGN_B0", "M(#mu^{+} #mu^{-}#pi^{+} #pi^{-}K_{0}^{s})[GeV]");
	draw2StackedHistos("VTXfit_BKG_B0_M" , "VTX_BKG_B0", "VTXfit_SGN_B0_M", "VTX_SGN_B0", "M(#mu^{+} #mu^{-}#pi^{+} #pi^{-}K_{0}^{s})[GeV]");
	draw2StackedHistos("PREfit_BKG_B0_M" , "PRE_BKG_B0", "PREfit_SGN_B0_M", "PRE_SGN_B0", "M(#mu^{+} #mu^{-}#pi^{+} #pi^{-}K_{0}^{s})[GeV]");
