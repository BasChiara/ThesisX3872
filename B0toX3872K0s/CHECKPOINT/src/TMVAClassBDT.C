...
// This loads the library
   ...
   //dataloader->AddSpectator( "spec2 := var1*3",  "Spectator 2", "units", 'F' );
	...
	if (Use["BDTbest"]){  // Adaptive Boost
		...
		factory->BookMethod( dataloader, TMVA::Types::kBDT, "BDT_nT100_b0.8_nC30",
		...
		factory->BookMethod( dataloader, TMVA::Types::kBDT, "BDT_nT100_b0.5_nC30",
		...
		factory->BookMethod( dataloader, TMVA::Types::kBDT, "BDT_nT200_b0.3_nC30",
		...
		factory->BookMethod( dataloader, TMVA::Types::kBDT, "BDT_nT100_b0.3_nC30",
		...
		factory->BookMethod( dataloader, TMVA::Types::kBDT, "BDT_nT50_b0.5_nC30",
		...
		factory->BookMethod( dataloader, TMVA::Types::kBDT, "BDT_nT50_b0.8_nC30",
