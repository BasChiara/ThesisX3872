...
parser.add_option("-i", "--input", dest="input",
                  help="batch directory to be checked", default = "/eos/user/c/cbasile/UNBLINDdataX3872")
...
outTreeName = "B0_X3872signal"
mergeOutFileName = "UNBL_MergData17_v2.root"
mergeOutHistName = "UNBLhistMergData17_v2.root"
...
TotEvents = 0
SampleEvs = 0
chain = ROOT.TChain("B0_X3872signal")
