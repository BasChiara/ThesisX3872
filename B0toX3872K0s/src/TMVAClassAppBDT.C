...
TString outFile_path = "/afs/cern.ch/user/c/cbasile/CMSSW-10-6-20-Analysis/src/BParkNANO/B0toX3872K0s/results/TMVAprovaApp.root"; 
...
void TMVAClassAppBDT( TString myMethodList = "" )
{
   ...
   TString dir    = "datasetBDT/weights/";
