...
Color_t CategoryColorMap(const TString& category){
  ...
  Color["PRE_SGN_X3872"] = kAzure + 1;
  Color["PRE_BKG_X3872"] = kOrange + 6;
  Color["TOT_SGN_X3872"] = kBlue - 9;
  Color["TOT_BKG_X3872"] = kMagenta - 6;
...
TString CategoryLegend(const TString& category){
  ...
  Leg_entry["PRE_SGN_Rho"] = "MC-matching #rho(770)";
  Leg_entry["PRE_BKG_Rho"] = "FAKE #rho(770)";

  Leg_entry["VTX_SGN_K0s"] = "MC-matching K_{0}^{s}";
  Leg_entry["VTX_BKG_K0s"] = "FAKE K_{0}^{s}";

  Leg_entry["PRE_SGN_X3872"] = "MC-matching pre-fit";
  Leg_entry["PRE_BKG_X3872"] = "FAKE pre-fit";
  Leg_entry["TOT_SGN_X3872"] = "MC-matching X(3872)";
  Leg_entry["TOT_BKG_X3872"] = "FAKE X(3872)";
  ...
  Leg_entry["TOT_SGN_B0"] = "MC-matching B_{0}";
  Leg_entry["TOT_BKG_B0"] = "FAKE B_{0}";
