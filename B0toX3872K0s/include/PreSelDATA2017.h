...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   ULong64_t       event;
   UInt_t          nB0;
   Float_t         B0_K0s_matchTrack1_D0sign[1000];   //[nB0]
   Float_t         B0_K0s_matchTrack1_dR[1000];   //[nB0]
   Float_t         B0_K0s_matchTrack1_eta[1000];   //[nB0]
   Float_t         B0_K0s_matchTrack1_maxD0Pv[1000];   //[nB0]
   Float_t         B0_K0s_matchTrack1_minD0Pv[1000];   //[nB0]
   Float_t         B0_K0s_matchTrack1_phi[1000];   //[nB0]
   Float_t         B0_K0s_matchTrack1_pt[1000];   //[nB0]
   Float_t         B0_K0s_matchTrack2_D0sign[1000];   //[nB0]
   Float_t         B0_K0s_matchTrack2_dR[1000];   //[nB0]
   Float_t         B0_K0s_matchTrack2_eta[1000];   //[nB0]
   Float_t         B0_K0s_matchTrack2_maxD0Pv[1000];   //[nB0]
   Float_t         B0_K0s_matchTrack2_minD0Pv[1000];   //[nB0]
   Float_t         B0_K0s_matchTrack2_phi[1000];   //[nB0]
   Float_t         B0_K0s_matchTrack2_pt[1000];   //[nB0]
   Float_t         B0_K0s_mcFitted_eta[1000];   //[nB0]
   Float_t         B0_K0s_mcFitted_mass[1000];   //[nB0]
   Float_t         B0_K0s_mcFitted_phi[1000];   //[nB0]
   Float_t         B0_K0s_mcFitted_pt[1000];   //[nB0]
   Float_t         B0_K0s_mcFitted_svprob[1000];   //[nB0]
   Float_t         B0_K0s_mcFitted_vtxX[1000];   //[nB0]
   Float_t         B0_K0s_mcFitted_vtxXE[1000];   //[nB0]
   Float_t         B0_K0s_mcFitted_vtxY[1000];   //[nB0]
   Float_t         B0_K0s_mcFitted_vtxYE[1000];   //[nB0]
   Float_t         B0_K0s_mcFitted_vtxZ[1000];   //[nB0]
   Float_t         B0_K0s_mcFitted_vtxZE[1000];   //[nB0]
   Float_t         B0_K0s_nmcFitted_mass[1000];   //[nB0]
   Float_t         B0_K0s_nmcFitted_pi1eta[1000];   //[nB0]
   Float_t         B0_K0s_nmcFitted_pi1phi[1000];   //[nB0]
   Float_t         B0_K0s_nmcFitted_pi1pt[1000];   //[nB0]
   Float_t         B0_K0s_nmcFitted_pi2eta[1000];   //[nB0]
   Float_t         B0_K0s_nmcFitted_pi2phi[1000];   //[nB0]
   Float_t         B0_K0s_nmcFitted_pi2pt[1000];   //[nB0]
   Float_t         B0_K0s_prefit_mass[1000];   //[nB0]
   Float_t         B0_MuMu_DCA[1000];   //[nB0]
   Float_t         B0_MuMu_LxySign[1000];   //[nB0]
   Float_t         B0_MuMu_cosAlpha[1000];   //[nB0]
   Float_t         B0_MuMu_fitted_eta[1000];   //[nB0]
   Float_t         B0_MuMu_fitted_mass[1000];   //[nB0]
   Float_t         B0_MuMu_fitted_phi[1000];   //[nB0]
   Float_t         B0_MuMu_fitted_pt[1000];   //[nB0]
   Float_t         B0_MuMu_fitted_vtxX[1000];   //[nB0]
   Float_t         B0_MuMu_fitted_vtxXE[1000];   //[nB0]
   Float_t         B0_MuMu_fitted_vtxY[1000];   //[nB0]
   Float_t         B0_MuMu_fitted_vtxYE[1000];   //[nB0]
   Float_t         B0_MuMu_fitted_vtxZ[1000];   //[nB0]
   Float_t         B0_MuMu_fitted_vtxZE[1000];   //[nB0]
   Float_t         B0_MuMu_mu1_dr[1000];   //[nB0]
   Float_t         B0_MuMu_mu1_dxysign[1000];   //[nB0]
   Float_t         B0_MuMu_mu1_dzsign[1000];   //[nB0]
   Float_t         B0_MuMu_mu2_dr[1000];   //[nB0]
   Float_t         B0_MuMu_mu2_dxysign[1000];   //[nB0]
   Float_t         B0_MuMu_mu2_dzsign[1000];   //[nB0]
   Float_t         B0_MuMu_prefit_mu1_eta[1000];   //[nB0]
   Float_t         B0_MuMu_prefit_mu1_phi[1000];   //[nB0]
   Float_t         B0_MuMu_prefit_mu1_pt[1000];   //[nB0]
   Float_t         B0_MuMu_prefit_mu2_eta[1000];   //[nB0]
   Float_t         B0_MuMu_prefit_mu2_phi[1000];   //[nB0]
   Float_t         B0_MuMu_prefit_mu2_pt[1000];   //[nB0]
   Float_t         B0_MuMu_sv_prob[1000];   //[nB0]
   Float_t         B0_PVEx[1000];   //[nB0]
   Float_t         B0_PVEy[1000];   //[nB0]
   Float_t         B0_PVEz[1000];   //[nB0]
   Float_t         B0_PVx[1000];   //[nB0]
   Float_t         B0_PVy[1000];   //[nB0]
   Float_t         B0_PVz[1000];   //[nB0]
   Float_t         B0_PiPi_pi1_d0sig[1000];   //[nB0]
   Float_t         B0_PiPi_pi1_dxysign[1000];   //[nB0]
   Float_t         B0_PiPi_pi1_dzsign[1000];   //[nB0]
   Float_t         B0_PiPi_pi1_maxd0PV[1000];   //[nB0]
   Float_t         B0_PiPi_pi1_mind0PV[1000];   //[nB0]
   Float_t         B0_PiPi_pi2_d0sig[1000];   //[nB0]
   Float_t         B0_PiPi_pi2_dxysign[1000];   //[nB0]
   Float_t         B0_PiPi_pi2_dzsign[1000];   //[nB0]
   Float_t         B0_PiPi_pi2_maxd0PV[1000];   //[nB0]
   Float_t         B0_PiPi_pi2_mind0PV[1000];   //[nB0]
   Float_t         B0_PiPi_prefit_pi1_eta[1000];   //[nB0]
   Float_t         B0_PiPi_prefit_pi1_phi[1000];   //[nB0]
   Float_t         B0_PiPi_prefit_pi1_pt[1000];   //[nB0]
   Float_t         B0_PiPi_prefit_pi1_vx[1000];   //[nB0]
   Float_t         B0_PiPi_prefit_pi1_vy[1000];   //[nB0]
   Float_t         B0_PiPi_prefit_pi1_vz[1000];   //[nB0]
   Float_t         B0_PiPi_prefit_pi2_eta[1000];   //[nB0]
   Float_t         B0_PiPi_prefit_pi2_phi[1000];   //[nB0]
   Float_t         B0_PiPi_prefit_pi2_pt[1000];   //[nB0]
   Float_t         B0_PiPi_prefit_pi2_vx[1000];   //[nB0]
   Float_t         B0_PiPi_prefit_pi2_vy[1000];   //[nB0]
   Float_t         B0_PiPi_prefit_pi2_vz[1000];   //[nB0]
   Float_t         B0_cosAlpha_PV[1000];   //[nB0]
   Float_t         B0_decayVtxX[1000];   //[nB0]
   Float_t         B0_decayVtxXE[1000];   //[nB0]
   Float_t         B0_decayVtxY[1000];   //[nB0]
   Float_t         B0_decayVtxYE[1000];   //[nB0]
   Float_t         B0_decayVtxZ[1000];   //[nB0]
   Float_t         B0_decayVtxZE[1000];   //[nB0]
   Float_t         B0_finalFit_JPsi_mass[1000];   //[nB0]
   Float_t         B0_finalFit_Rho_mass[1000];   //[nB0]
   Float_t         B0_finalFit_X_mass[1000];   //[nB0]
   Float_t         B0_finalFit_eta[1000];   //[nB0]
   Float_t         B0_finalFit_k0s_eta[1000];   //[nB0]
   Float_t         B0_finalFit_k0s_phi[1000];   //[nB0]
   Float_t         B0_finalFit_k0s_pt[1000];   //[nB0]
   Float_t         B0_finalFit_mass[1000];   //[nB0]
   Float_t         B0_finalFit_mu1_eta[1000];   //[nB0]
   Float_t         B0_finalFit_mu1_phi[1000];   //[nB0]
   Float_t         B0_finalFit_mu1_pt[1000];   //[nB0]
   Float_t         B0_finalFit_mu2_eta[1000];   //[nB0]
   Float_t         B0_finalFit_mu2_phi[1000];   //[nB0]
   Float_t         B0_finalFit_mu2_pt[1000];   //[nB0]
   Float_t         B0_finalFit_phi[1000];   //[nB0]
   Float_t         B0_finalFit_pi1_eta[1000];   //[nB0]
   Float_t         B0_finalFit_pi1_phi[1000];   //[nB0]
   Float_t         B0_finalFit_pi1_pt[1000];   //[nB0]
   Float_t         B0_finalFit_pi2_eta[1000];   //[nB0]
   Float_t         B0_finalFit_pi2_phi[1000];   //[nB0]
   Float_t         B0_finalFit_pi2_pt[1000];   //[nB0]
   Float_t         B0_finalFit_pt[1000];   //[nB0]
   Float_t         B0_fitted_mass_womc[1000];   //[nB0]
   Float_t         B0_lxySign_PV[1000];   //[nB0]
   Float_t         B0_svchi2[1000];   //[nB0]
   Float_t         B0_svprob[1000];   //[nB0]
   Int_t           B0_K0s_matchTrack1_fired_DoubleMu4_JpsiTrkTrk_Displaced[1000];   //[nB0]
   Int_t           B0_K0s_matchTrack1_fired_DoubleMu4_JpsiTrk_Displaced[1000];   //[nB0]
   Int_t           B0_K0s_matchTrack1_fired_DoubleMu4_PsiPrimeTrk_Displaced[1000];   //[nB0]
   Int_t           B0_K0s_matchTrack2_fired_DoubleMu4_JpsiTrkTrk_Displaced[1000];   //[nB0]
   Int_t           B0_K0s_matchTrack2_fired_DoubleMu4_JpsiTrk_Displaced[1000];   //[nB0]
   Int_t           B0_K0s_matchTrack2_fired_DoubleMu4_PsiPrimeTrk_Displaced[1000];   //[nB0]
   Int_t           B0_MuMu_mu1_fired_Dimuon18_PsiPrime[1000];   //[nB0]
   Int_t           B0_MuMu_mu1_fired_Dimuon25_Jpsi[1000];   //[nB0]
   Int_t           B0_MuMu_mu1_fired_DoubleMu4_JpsiTrkTrk_Displaced[1000];   //[nB0]
   Int_t           B0_MuMu_mu1_fired_DoubleMu4_JpsiTrk_Displaced[1000];   //[nB0]
   Int_t           B0_MuMu_mu1_fired_DoubleMu4_PsiPrimeTrk_Displaced[1000];   //[nB0]
   Int_t           B0_MuMu_mu2_fired_Dimuon18_PsiPrime[1000];   //[nB0]
   Int_t           B0_MuMu_mu2_fired_Dimuon25_Jpsi[1000];   //[nB0]
   Int_t           B0_MuMu_mu2_fired_DoubleMu4_JpsiTrkTrk_Displaced[1000];   //[nB0]
   Int_t           B0_MuMu_mu2_fired_DoubleMu4_JpsiTrk_Displaced[1000];   //[nB0]
   Int_t           B0_MuMu_mu2_fired_DoubleMu4_PsiPrimeTrk_Displaced[1000];   //[nB0]
   Int_t           B0_PiPi_p1_fired_DoubleMu4_JpsiTrkTrk_Displaced[1000];   //[nB0]
   Int_t           B0_PiPi_p1_fired_DoubleMu4_JpsiTrk_Displaced[1000];   //[nB0]
   Int_t           B0_PiPi_p1_fired_DoubleMu4_PsiPrimeTrk_Displaced[1000];   //[nB0]
   Int_t           B0_PiPi_p2_fired_DoubleMu4_JpsiTrkTrk_Displaced[1000];   //[nB0]
   Int_t           B0_PiPi_p2_fired_DoubleMu4_JpsiTrk_Displaced[1000];   //[nB0]
   Int_t           B0_PiPi_p2_fired_DoubleMu4_PsiPrimeTrk_Displaced[1000];   //[nB0]
   Int_t           B0_dimuon_idx[1000];   //[nB0]
   Int_t           B0_dipion_idx[1000];   //[nB0]
   Int_t           B0_k0short_idx[1000];   //[nB0]
   Int_t           B0_mu1_idx[1000];   //[nB0]
   Int_t           B0_mu2_idx[1000];   //[nB0]
   Int_t           B0_pi1_idx[1000];   //[nB0]
   Int_t           B0_pi2_idx[1000];   //[nB0]
   Int_t           B0_pv_idx[1000];   //[nB0]
   UInt_t          nJPsiToMuMu;
   UInt_t          nK0s;
   UInt_t          npipi;
   UInt_t          nMuon;
